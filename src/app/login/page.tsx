    ...
    return (
        <div className='flex items-center justify-center min-h-screen bg-gray-400'>
            ...
            >
                ...
                <input className='bg-violet-600 p-2 rounded'
                    type="email"
                    placeholder='Email'
                    value={email}
                ...
                />
                <input
                    className='bg-violet-600 p-2 rounded'
                    type="password"
                ...
                <div className=' w-full flex items-center justify-center '>
                    <button className='bg-violet-900 px-5 rounded-2xl py-1' type='submit'>Login</button>
